...
- We took a look at the spikes in CB and CNCB
- We improved the flipped network app
  - We implemented different weight schemes
  - We implemented the color scheme for affiliation
  - Tooltips are working for node info
- We looked at PageRank in a bidirectional graph

## We're Still Working On
- We still have work to do on the flipped network
  - We want to implement the size of nodes proportional to number of org members
  - We still need to get tooltips for edges working
- Getting more granular CB scores -> aggregating over time
- Different Direction schemes
- Gov and Opp Orgs Graph Metric Comparisons
...
## Questions
- What should we push to finish by the end of the quarter? 
